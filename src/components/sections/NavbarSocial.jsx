        ...
        <Navbar>
          ...
          >
            <img
              ...
              className={`${
                scrolling
                  ? "w-[50%] tablet1:w-[40%] tablet2:w-[40%] desktop1:w-[30%] desktop2:w-[30%] transition-all duration-1000 rounded-md"
                  : "my-[20px] w-[70%] tablet1:w-[50%] tablet2:w-[50%] desktop1:w-[50%] desktop2:w-[50%] transition-all duration-1000 rounded-md"
              } tablet3:mb-0`}
            />
          </ScrollLink>
