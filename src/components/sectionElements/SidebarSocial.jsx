            ...
            <div
              ...
              className={`${
                colorMode
                  ...
                  : "absolute top-0 left-0 flex-shrink-0 h-screen border-r-[1px] select-none bg-bgSectionOpacityDark surface-section lg:hidden lg:static z-1 surface-border border-neutral-700"
              }`}
              style={{ width: "280px" }}
            >
                ...
                <div className="flex items-center justify-between flex-shrink-0 px-4 pt-6">
                  <span className="inline-flex items-center gap-2">
                    <img
                      ...
                      className="w-[90%] h-auto bg-white rounded-md p-2"
                    />
                  </span>
                  <span>
                    <Button
